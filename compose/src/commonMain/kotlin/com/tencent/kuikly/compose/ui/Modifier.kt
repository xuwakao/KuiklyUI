...
import com.tencent.kuikly.compose.ui.node.NodeKind
import com.tencent.kuikly.compose.ui.node.ObserverNodeOwnerScope
 ...
 *
 * @sample com.tencent.kuikly.compose.ui.samples.ModifierUsageSample
 *
 ...
 *
 * @sample com.tencent.kuikly.compose.ui.samples.ModifierFactorySample
 *
 ...
 * For example:
 *
 * @sample com.tencent.kuikly.compose.ui.samples.ModifierParameterSample
 *
 ...
 *
 * @sample com.tencent.kuikly.compose.ui.samples.SubcomponentModifierSample
 */
...
interface Modifier {
     ...
     * [com.tencent.kuikly.compose.ui.layout.Layout]. Most [Modifier.Node] implementations will have a
     ...
     *
     * When a [Modifier] is set on a [com.tencent.kuikly.compose.ui.layout.Layout], each [Modifier.Element]
     * contained in that linked list will result in a corresponding [Modifier.Node] instance in a
     * matching linked list of [Modifier.Node]s that the [com.tencent.kuikly.compose.ui.layout.Layout] will
     * hold on to. As subsequent [Modifier] chains get set on the
     * [com.tencent.kuikly.compose.ui.layout.Layout], the linked list of [Modifier.Node]s will be diffed and
     ...
     * [com.tencent.kuikly.compose.ui.layout.Layout] that it lives on and a corresponding [Modifier.Element]
     * being present in the [com.tencent.kuikly.compose.ui.layout.Layout]'s [Modifier].
     *
     ...
     * [com.tencent.kuikly.compose.ui.node.ModifierNodeElement] to a [Modifier] chain.
     *
     * @see com.tencent.kuikly.compose.ui.node.ModifierNodeElement
     * @see com.tencent.kuikly.compose.ui.node.CompositionLocalConsumerModifierNode
     * @see com.tencent.kuikly.compose.ui.node.DelegatableNode
     * @see com.tencent.kuikly.compose.ui.node.DelegatingNode
     * @see com.tencent.kuikly.compose.ui.node.LayoutModifierNode
     * @see com.tencent.kuikly.compose.ui.node.DrawModifierNode
     * @see com.tencent.kuikly.compose.ui.node.SemanticsModifierNode
     * @see com.tencent.kuikly.compose.ui.node.PointerInputModifierNode
     * @see com.tencent.kuikly.compose.ui.modifier.ModifierLocalModifierNode
     * @see com.tencent.kuikly.compose.ui.node.ParentDataModifierNode
     * @see com.tencent.kuikly.compose.ui.node.LayoutAwareModifierNode
     * @see com.tencent.kuikly.compose.ui.node.GlobalPositionAwareModifierNode
     * @see com.tencent.kuikly.compose.ui.node.IntermediateLayoutModifierNode
     */
    abstract class Node : DelegatableNode {
         ...
         *
         * @sample com.tencent.kuikly.compose.ui.samples.ModifierNodeCoroutineScopeSample
         *
        ...
        /**
         * Indicates that the node is attached to a [com.tencent.kuikly.compose.ui.layout.Layout] which is
         * part of the UI tree.
        ...
        /**
         * Called when the node is attached to a [com.tencent.kuikly.compose.ui.layout.Layout] which is
         * part of the UI tree.
        ...
        /**
         * Called when the node is not attached to a [com.tencent.kuikly.compose.ui.layout.Layout] which is
         ...
         * [com.tencent.kuikly.compose.ui.layout.Layout] displaying a semantically different content when
         ...
         *
         * @sample com.tencent.kuikly.compose.ui.samples.ModifierNodeResetSample
         */
        open fun onReset() {}
