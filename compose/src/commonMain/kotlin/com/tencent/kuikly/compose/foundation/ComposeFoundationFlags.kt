...
object ComposeFoundationFlags {
     ...
     * [SelectionContainer][com.tencent.kuikly.compose.foundation.text.selection.SelectionContainer], and all
     * [BasicTextField][com.tencent.kuikly.compose.foundation.text.BasicTextField]s. If false, the previous
     ...
     * [com.tencent.kuikly.compose.foundation.text.selection.SelectionContainer] and all
     * [com.tencent.kuikly.compose.foundation.text.BasicTextField]s.
     */
     ...
     * [com.tencent.kuikly.compose.foundation.lazy.LazyListPrefetchStrategy] and
     * [com.tencent.kuikly.compose.foundation.lazy.grid.LazyGridPrefetchStrategy] or Cache Window will be
     ...
     * [com.tencent.kuikly.compose.foundation.selection.selectable], and
     * [com.tencent.kuikly.compose.foundation.selection.toggleable], which also use [clickable]. When this
     * flag is true, [clickable] will no longer use [com.tencent.kuikly.compose.ui.composed], which leads to
     ...
     * [com.tencent.kuikly.compose.ui.node.DelegatableNode.dispatchOnScrollChanged] callbacks during scroll
     * events.
     */
     ...
     * is added to the [com.tencent.kuikly.compose.ui.input.pointer.util.VelocityTracker]. Pointer Input
     ...
     * [com.tencent.kuikly.compose.ui.input.pointer.PointerInputChange] API.
     */
    @Suppress("MutableBareField")
    @JvmField
     ...
     * [com.tencent.kuikly.compose.foundation.text.input.TextFieldState] changes their behavior of how they
