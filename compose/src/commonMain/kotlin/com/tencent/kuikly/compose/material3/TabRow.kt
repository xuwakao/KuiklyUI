...
import com.tencent.kuikly.compose.material3.tokens.SecondaryNavigationTabTokens
...
import com.tencent.kuikly.compose.foundation.ScrollingLayoutElement
...
fun ScrollableTabRow(
    ...
    indicator: @Composable (tabPositions: List<TabPosition>) -> Unit =
        @Composable { tabPositions ->
            TabRowDefaults.SecondaryIndicator(
                Modifier.tabIndicatorOffset(tabPositions[selectedTabIndex]).fixScrollOffset(true)
            )
        },
    divider: @Composable () -> Unit = @Composable { HorizontalDivider() },
    tabs: @Composable () -> Unit
...
private fun TabRowWithSubcomposeImpl(
    ...
    Surface(
        ...
        SubcomposeLayout(
            modifier = Modifier.fillMaxWidth().setProp("scrollEnabled", 0),
    ...
    Surface(modifier = modifier, color = containerColor, contentColor = contentColor) {
        ...
        SubcomposeLayout(
            ...
            measurePolicy = { constraints ->
                ...
                scrollState.maxValue = contentWidth - layoutWidth
                scrollState.viewportSize = layoutWidth
                ...
                layout(layoutWidth, layoutHeight) {
                    ...
                    var left = padding
                    tabPlaceables.fastForEachIndexed { index, placeable ->
                        placeable.placeRelative(left - scrollState.value, 0)
                        tabPositions.add(
                            TabPosition(
                                left = left.toDp(),
                    ...
                    subcompose(TabSlots.Divider, divider).fastForEach {
                        ...
                        placeable.placeRelative(-scrollState.value, layoutHeight - placeable.height)
                    }
                    ...
                    subcompose(TabSlots.Indicator) { indicator(tabPositions) }
                        .fastForEach {
                            it.measure(Constraints.fixed(layoutWidth, layoutHeight)).placeRelative(-scrollState.value, 0)
                        }
...
private val ScrollableTabRowMinimumTabWidth = 5.dp
