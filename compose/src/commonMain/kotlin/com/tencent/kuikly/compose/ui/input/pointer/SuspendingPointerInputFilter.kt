...
import com.tencent.kuikly.compose.ui.util.fastMapNotNull
 ...
 *
 * @sample com.tencent.kuikly.compose.ui.samples.keyedPointerInputModifier
 *
 ...
 *
 * @sample com.tencent.kuikly.compose.ui.samples.rememberedUpdatedParameterPointerInputModifier
 */
fun Modifier.pointerInput(
    key1: Any?,
    block: suspend PointerInputScope.() -> Unit
...
internal class SuspendingPointerInputModifierNodeImpl(
    ...
    override val layoutNode
        get() = requireLayoutNode()
    ...
    private inner class PointerEventHandlerCoroutine<R>(
        ...
        override val layoutNode: LayoutNode
            get() = this@SuspendingPointerInputModifierNodeImpl.layoutNode
