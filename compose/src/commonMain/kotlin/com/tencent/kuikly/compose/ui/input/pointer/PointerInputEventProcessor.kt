...
import com.tencent.kuikly.compose.ui.input.pointer.InternalPointerEvent
...
internal class PointerInputEventProcessor(val root: LayoutNode) {
    ...
    fun process(
        ...
        onProcessResult: (ProcessResult) -> Unit = {}
    ): ProcessResult {
        if (isProcessing) {
        ...
        try {
            ...
            for (i in 0 until internalPointerEvent.changes.size()) {
                ...
                if (isHover || pointerInputChange.changedToDownIgnoreConsumed()) {
                    ...
                    if (pointerEvent.rootNode != null) {
                        pointerEvent.rootNode.hitTest(pointerInputChange.position, hitResult, isTouchEvent)
            ...
            if (internalPointerEvent.nativeEvent != null) {
...
value class ProcessResult(private val value: Int) {
