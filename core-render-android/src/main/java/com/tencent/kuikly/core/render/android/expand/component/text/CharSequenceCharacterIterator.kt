...
internal class CharSequenceCharacterIterator(
    ...
    private val end: Int = charSequence.length
     ...
     * position.
     *
     * @return the first character in the text, or [CharacterIterator.DONE] if
     * the text is empty
     * @see getBeginIndex
     */
     ...
     *
     * @return the last character in the text, or [CharacterIterator.DONE] if the
     * text is empty
     ...
     *
     * @return the character at the current position or [CharacterIterator.DONE]
     * if the current
     ...
     * a value of [CharacterIterator.DONE] is returned.
     *
     * @return the character at the new position or [CharacterIterator.DONE] if
     * the new
     ...
     * remains at getBeginIndex() and a value of [CharacterIterator.DONE] is
     * returned.
     *
     * @return the character at the new position or [CharacterIterator.DONE] if
     * the current
     ...
     * [CharacterIterator.DONE] if the specified
