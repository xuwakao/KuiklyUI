# Compose Android：横屏 Dialog 与 TextField 软键盘

> **status: implemented** — 对应变更见 `openspec/changes/archive/2026-05-12-compose-landscape-dialog-textfield-keyboard/`。

## 目的

约束 demo、Android 宿主调试入口与官网文档：在 Android 横屏 + 独立 Window 浮层场景下，Compose `TextField` 软键盘可复现、可规避，且其他平台不因该变更产生回归。
